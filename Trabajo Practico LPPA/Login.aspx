...
<body>
	<!-- start preloader -->
        ...
        <br />
        <br /> 
    <div style="width:100%; height: 100%; display:flex; flex-flow:nowrap;">
        <form id="form1" runat="server">
            <div style="background-color: #303030; padding-left: 200px; width:100%; height: 100%; display:inline-block;">
            USUARIO&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp
            ...
            <aside style="display:-webkit-inline-box; width:100%; height: 100%;">
                <asp:AdRotator ID="AdRotator1" runat="server" AdvertisementFile="~/AdPerros.xml" Height="160" Width="200" />
                <asp:AdRotator ID="AdRotator3" runat="server" AdvertisementFile="~/AdAlimento.xml" Height="160" Width="200" />
                <asp:AdRotator ID="AdRotator4" runat="server" AdvertisementFile="~/AdPerros.xml" Height="160" Width="200" />
            </aside>
    </div>
</body>
</html>
