...
namespace DAL
{
    public class Acceso_DAL
    {
        ...
        //SqlConnection conexion = new SqlConnection(@"Data Source = LAPTOP-RGP5HKC3\MSSQLSERVER01; Initial CAtalog = VeterinariaLPPA; Integrated Security = SSPI");
        SqlConnection  conexion = new SqlConnection(ConfigurationManager.AppSettings["cadena_conexion"].ToString());     
        ...
        public DataTable EjecutarStoredProcedure(string storeprocedure, SqlParameter[] parametros)
        {
