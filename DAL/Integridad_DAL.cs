...
namespace DAL
{
    public class Integridad_DAL
    {
        ...
        private void GuardarNuevoDigitoVerificador(string pTabla, string DigitoVerificador)
        {
            ...
            DataTable Tabla = ac.EjecutarStoredProcedure("llenar_digito_verificador", parametros);
        }
        ...
        private void ModificarDigitoVerificador(string pTabla, string DigitoVerificador)
        {
            ...
            DataTable Tabla = ac.EjecutarStoredProcedure("modificar_digito_verificador", parametros);
        ...
        private void BorrarDigitoVerificador(string pTabla)
        {
            ...
            DataTable Tabla = ac.EjecutarStoredProcedure("borrar_digito_verificador", parametros);
        }
